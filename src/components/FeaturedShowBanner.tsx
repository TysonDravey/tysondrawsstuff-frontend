...
export default function FeaturedShowBanner({ show, products }: FeaturedShowBannerProps) {
  ...
  return (
    <section className="py-12 bg-gradient-to-br from-amber-50 to-orange-50 border-y border-amber-200">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="text-center mb-8">
            <span className="inline-block bg-amber-600 text-white text-sm font-bold px-4 py-2 rounded-full mb-4">
              🎨 CURRENT SHOW
            </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            ...
            {show.logo && (
              <div className="lg:col-span-1">
                <div className="aspect-square bg-white rounded-lg overflow-hidden shadow-lg border-2 border-amber-200 relative max-w-sm mx-auto">
                  <Image
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4">
                    <Link
                      ...
                      className="inline-flex items-center justify-center w-full bg-amber-600 hover:bg-amber-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors"
                    >
                      View Show Details
